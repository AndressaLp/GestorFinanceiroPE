...
function EditClient({clientId}){
    ...
    return(
        <div>
            ...
            <div className="grid grid-cols-[4.5fr_1fr] min-lg:gap-15 max-md:gap-5 md:gap-10">
            ...
            <div className="grid grid-cols-[2fr_2fr_1fr] min-lg:gap-15 max-md:gap-5 md:gap-10">
